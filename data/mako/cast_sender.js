(function() {
    console.log("I am your cast_sender");
    var e = function(a) {
    ...
    if (q("CriOS")) {
        ...
        m(["//www.gstatic.com/eureka/clank/" + (u ? parseInt(u[1], 10) : 0) + f, "//www.gstatic.com/eureka/clank" + f])
    } else
        window.chrome && window.navigator.presentation && !q("Edge") ? (r(),
        m(k.map(p))) :*/ n();
}
)();
